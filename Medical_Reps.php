...
$pageTitle = 'Medical Reps';
    ...
    if ($do == 'Manage') { // Manage Members Page
        ...
        */
        ...
        $stmt = $con->prepare("SELECT * FROM medical_rep");
            ...
            <div class="container">
                <div class="table-responsive">
                    <table class="main-table text-center table table-bordered">
                        ...
                        foreach($rows as $row) {
                            echo "<tr>";
                            echo "<td>" . $row['MR_ID'] . "</td>";
                            echo "<td>" . $row['Name'] . "</td>" ;
                            echo "<td>" . $row['Email'] . "</td>";
                            echo "<td>" . $row['Medcine'] . "</td>";
                            echo "<td>" . $row['Medcine_Quantity'] ."</td>";
                            echo "<td>" . $row['Medcine_Distriputed'] ."</td>";
                            echo "<td>
                              
										<a href='members.php?do=Edit&userid=" . $row['MR_ID'] . "' class='btn btn-success'><i class='fa fa-edit'></i> Edit</a>
										<a href='members.php?do=Delete&userid=" . $row['MR_ID'] . "' class='btn btn-danger confirm'><i class='fa fa-close'></i> Delete </a>";
                            /*
                            if ($row['RegStatus'] == 0) {
                                echo "<a 
                ...
                <a href="members.php?do=Add" class="btn btn-primary">
                    <i class="fa fa-plus"></i> New Medical Rep
                </a>
            </div>
