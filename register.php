<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
			...
			if (empty($formErrors)) {
				...
				$check = checkItem("Name", "medical_repersentative", $username);
				...
				if ($check == 1) {
					...
					$stmt = $con->prepare("INSERT INTO 
											medical_repersentative(Name, password, email , Telphone , RegStatus, Date)
        ...
        <div class="avatar img-circle img-responsive">
            ...
            <div class="form-box">
              <form class="login" action="" method="POST">
                  ...
                  <input type="text" name="telphone" autocomplete="new-password" placeholder="Type your password" required />
